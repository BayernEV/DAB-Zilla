// $HeadURL: svn://127.0.0.1/DABZilla/trunk/src/Keystone.d $
// $Id: Keystone.d 35 2014-11-22 20:33:42Z evoigt $
...
extern (C++) {
    ...
    */
    ...
    /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
       ...
       Return 0 when current mode is DAB or 1 when current mode is FM.  Any other value
       is invalid and -1 when function failed.
    */
    __gshared char DAB = cast(char)0;
    __gshared char FM  = cast(char)1;
    char GetPlayMode();
    ...
    */
    ...
    /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
       ...
       In RadioDNS's hostname example, developer will need to supply ECC to form the hostname.
       Our board does not send out ECC, developers need to hardcode ECC based on their country
       of origin.  John Jore from Australia shared this
       link http://web.itu.edu.tr/~pazarci/rtv/rbds1998.pdf, Annex D and N, while
    ...
    */
    ...
    /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
       ...
       Remark
       Before calling GetRTC(), call SyncRTC(true) first, then call GetRTC() in a loop to wait
       for it to return a true.  The parameters returned are valid date and time once it returns true.
    */
    bool GetRTC(
                ubyte *sec,
                ubyte *min,
